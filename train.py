...
def main(args):
    ...
    model = DARTS(
        operations=dict(
            sep_conv_3x3=functools.partial(SeparableConv2d, kernel_size=3, padding=1, affine=True),
            sep_conv_5x5=functools.partial(SeparableConv2d, kernel_size=5, padding=2, affine=True),
            dil_conv_3x3=functools.partial(DilatedConv2d, kernel_size=3, padding=2, dilation=2, affine=True),
            dil_conv_5x5=functools.partial(DilatedConv2d, kernel_size=5, padding=4, dilation=2, affine=True),
            ...
            identity=functools.partial(Conv2d, kernel_size=1, padding=0, affine=True),
